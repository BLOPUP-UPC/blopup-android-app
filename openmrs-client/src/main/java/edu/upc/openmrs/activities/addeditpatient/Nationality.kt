...
enum class Nationality(val label: Int, val flag: Int) {
    ...
    BUTHAN(R.string.bhutan, R.drawable.flag_bhutan),
    ...
    COTE_DIVORIRE(R.string.cote_divoire, R.drawable.flag_cote_divoire),
    ...
    FRENCH_POLINESIA(R.string.french_polynesia, R.drawable.flag_french_polynesia),
    ...
    GUADALOUPE(R.string.guadeloupe, R.drawable.flag_guadeloupe),
    GUAM(R.string.guam, R.drawable.flag_guam),
    GUATEMALA(R.string.guatemala, R.drawable.flag_guatemala),
    GUERNSEY_AND_OLDERNEY(R.string.guernsey_and_alderney, R.drawable.flag_guernsey),
    ...
    LUXENBOURG(R.string.luxembourg, R.drawable.flag_luxembourg),
    ...
    NAIMIBIA(R.string.namibia, R.drawable.flag_namibia),
    ...
    NORTHEN_MARIANA_ISLANDS(R.string.northern_mariana_islands, R.drawable.flag_northern_mariana_islands),

...
import edu.upc.sdk.utilities.ApplicationConstants.BundleKeys.FORM_FIELDS_LIST_BUNDLE
import edu.upc.sdk.utilities.ApplicationConstants.BundleKeys.FORM_NAME
import edu.upc.sdk.utilities.ApplicationConstants.BundleKeys.PATIENT_ID_BUNDLE
import edu.upc.sdk.utilities.ApplicationConstants.BundleKeys.VALUEREFERENCE
...
@AndroidEntryPoint
class PatientVitalsFragment : edu.upc.openmrs.activities.BaseFragment() {
    ...
    private fun showEncounterVitals(encounter: Encounter) {
        if (encounter.observations.isNotEmpty()) {
            with(binding) {
                ...
                val openMRSInflater = edu.upc.openmrs.application.OpenMRSInflater(layoutInflater)
    ...
    private fun startFormDisplayActivity(encounter: Encounter) {
        ...
        if (form != null) {
            val intent = Intent(context, VitalsFormActivity::class.java)
            ...
            intent.putParcelableArrayListExtra(FORM_FIELDS_LIST_BUNDLE, edu.upc.openmrs.bundle.FormFieldsWrapper.create(encounter))

...
import edu.upc.sdk.library.api.workers.allergy.DeleteAllergyWorker;
        ...
        return AppDatabaseHelper.createObservableIO(() -> {
            if (NetworkUtils.isOnline()) {
                ...
                Data data = new Data.Builder()
                        .putString(ApplicationConstants.BundleKeys.PATIENT_UUID, patientUuid)
                        .putString(ApplicationConstants.BundleKeys.ALLERGY_UUID, allergyUuid)
                        .build();
                allergyRoomDAO.deleteAllergyByUUID(allergyUuid);

...
class TreatmentAdherenceTest {
    ...
    fun `if fetch treatment is success, it should ask if patient is following those treatments`() {
        ...
        composeTestRule.setContent {
            TreatmentAdherence(treatments = ResultUiState.Success(listOf(treatment)), createVisit = {}, treatmentAdherence = {}) {
            }
        }
        ...
        composeTestRule.onNodeWithText(treatment.medicationName).assertIsDisplayed()
